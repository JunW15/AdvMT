...
class LSTMDecoder(FairseqIncrementalDecoder):
    ...
    def extract_features(
        ...
        set_incremental_state(self, incremental_state, 'cached_state', cache_state)
    ...
    def reorder_incremental_state(self, incremental_state: Optional[Dict[str, Dict[str, Optional[Tensor]]]], new_order):
        ...
        set_incremental_state(self, incremental_state, 'cached_state', cached_state_new),
        return
