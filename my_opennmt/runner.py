...
from my_opennmt import models
from my_opennmt import training as training_util
...
class Runner(object):
    ...
    def train(
        ...
        #    DP
        # =========
        if train_config["is_dpsgd"]:
            print('[Using dpsgd]')
            optimizer = model.get_dp_optimizer()
        else:
        ...
        if hvd is not None:
            ...
            trainer = training_util.Trainer(model, optimizer,
                                            checkpoint=checkpoint,
                                            batch_size=train_config["batch_size"],
                                            is_dpsgd=train_config["is_dpsgd"])
